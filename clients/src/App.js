...
//         <Route path="/combined-approach" element={<TheCombined/>} />
...
import {
  ...
  TheCombined,
  ProtectedRoute,
} from "./components"; // Make sure ProtectedRoute is imported here!
import { Combined } from "./assets";
...
const App = () => {
  ...
  useEffect(() => {
    ...
    firebaseAuth.onAuthStateChanged((cred) => {
      ...
      // Consider removing this setInterval in the future.
      // It forces a 3-second minimum loading screen even if Firebase responds instantly.
      setInterval(() => {
        setIsLoading(false);
      }, 3000);
    });
